...
CREATE TABLE IF NOT EXISTS file_chunks (chunk_id TEXT, repo_id TEXT, path TEXT, path_text TEXT, language TEXT, chunk_kind TEXT, chunk_start INTEGER, chunk_end INTEGER, title TEXT, description TEXT, content TEXT, search_text TEXT);
