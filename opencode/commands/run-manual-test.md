...
4. Only after ticket scope is explicit, ensure shared auth exists at `apps/playwright-tests/.auth/dev.json`.
...
9. Process selected tickets one at a time while using the shared auth state.
